...
namespace EcommerceWeb.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Category,CategoryName")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Category,CategoryName")] Category category)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            var listProduct = db.Products.Where(n => n.ID_Category == id).ToList();
